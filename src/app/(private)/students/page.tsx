            ...
            <div key={student.id} className="mb-2">
              <div
                className={`collapse collapse-arrow bg-base-200 rounded-box ${
                  openAccordionId === student.id ? "collapse-open" : ""
                }`}
              >
                <input
                  type="checkbox"
                  className="peer"
                  checked={openAccordionId === student.id}
                  onChange={() => handleAccordion(student.id)}
                />
                ...
                <div className="collapse-content">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <StudentInfo
                        label="Idade"
                        value={`${calculateAge(student.birth_date)} anos`}
                      />
                      <StudentInfo
                        label="Sexo"
                        value={GenderEnum[student.gender]}
                      />
                    </div>
                    <div>
