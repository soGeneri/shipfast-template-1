...
import { AssessmentTypeEnum } from "@/lib/enums";
...
const steps = [
  ...
  },
  {
    ...
    fields: [
      ...
      "assessmentMeasures.thigh",
      "assessmentMeasures.chest",
      "assessmentMeasures.triceps",
      "assessmentMeasures.calf",
      "assessmentMeasures.abdomen",
      "assessmentMeasures.suprailiac",
      "assessmentMeasures.subscapular",
      "assessmentMeasures.axilla",
    ],
  },
  {
    id: "Step 4",
...
export default function Register() {
  ...
  const formatBirthDate = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setValue(event.target.name as keyof Inputs, formatted, {
      shouldValidate: true,
    });
  };
  ...
  const handleForm: SubmitHandler<Inputs> = async (data) => {
    try {
      ...
      toast.error(
        `Erro ao criar a avaliação, entre em contato com o suporte. ${JSON.stringify(
          error
        )}`
      );
    }
  ...
  const renderPollock3 = () => {
    const student = students.find(
      (student) => student.id === getValues("studentId")
    );
    ...
    if (gender === "male") {
      return (
        <>
          <div>
            <label htmlFor="assessmentMeasures.chest" className="label">
              Peito
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="assessmentMeasures.abdomen" className="label">
              Abdômen
            </label>
            <input
              type="text"
              id="assessmentMeasures.abdomen"
              {...register("assessmentMeasures.abdomen", {
                valueAsNumber: true,
              })}
              className="input input-bordered w-full placeholder:opacity-60"
            />
          ...
          <div>
            <label htmlFor="assessmentMeasures.thigh" className="label">
              Coxa
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="assessmentMeasures.weight" className="label">
              Peso
            </label>
            <input
              type="text"
              id="assessmentMeasures.weight"
              {...register("assessmentMeasures.weight", {
                valueAsNumber: true,
              })}
              className="input input-bordered w-full placeholder:opacity-60"
            />
          ...
          <div>
            <label htmlFor="assessmentMeasures.height" className="label">
              Altura
            </label>
            <input
              type="text"
              id="assessmentMeasures.height"
              {...register("assessmentMeasures.height", {
                valueAsNumber: true,
              })}
              className="input input-bordered w-full placeholder:opacity-60"
            />
      ...
      return (
        <>
          <div>
            <label htmlFor="assessmentMeasures.triceps" className="label">
              Tríceps
            </label>
            <input
              type="text"
              id="assessmentMeasures.triceps"
              {...register("assessmentMeasures.triceps", {
                valueAsNumber: true,
              })}
              className="input input-bordered w-full placeholder:opacity-60"
            />
          ...
          <div>
            <label htmlFor="assessmentMeasures.suprailiac" className="label">
              Supra-ilíaca
            </label>
            <input
              type="text"
              id="assessmentMeasures.suprailiac"
              {...register("assessmentMeasures.suprailiac", {
                valueAsNumber: true,
              })}
              className="input input-bordered w-full placeholder:opacity-60"
            />
    ...
    if (gender === "male") {
      return (
        <>
          ...
          <div>
            <label htmlFor="assessmentMeasures.subscapular" className="label">
              Subescapular
            </label>
            <input
              type="text"
              id="assessmentMeasures.subscapular"
              {...register("assessmentMeasures.subscapular", {
                valueAsNumber: true,
              })}
              className="input input-bordered w-full placeholder:opacity-60"
            />
          ...
          <div>
            <label htmlFor="assessmentMeasures.axilla" className="label">
              Axila
            </label>
            <input
              type="text"
              id="assessmentMeasures.axilla"
              {...register("assessmentMeasures.axilla", {
                valueAsNumber: true,
              })}
              className="input input-bordered w-full placeholder:opacity-60"
            />
          ...
          <div>
            <label htmlFor="assessmentMeasures.calf" className="label">
              Panturrilha
            </label>
            <input
              type="text"
      ...
      <div className="mt-2">
        <div className="flex flex-row space-x-8">
          <div className="flex flex-col">
            <div>
              <strong>Nome do Aluno:</strong> {selectedStudent?.name}{" "}
              {selectedStudent?.surname}
            </div>
            <div>
              <strong>Tipo de Avaliação:</strong>{" "}
              {assessmentTypeMapper[assessmentType]}
            </div>
          </div>
        ...
        <div>
          <strong>
            Medidas da Avaliação ({assessmentTypeMapper[assessmentType]})
          </strong>
          <ul>
            {assessmentMeasures ? (
              Object.entries(assessmentMeasures).map(([key, value]) => {
                const translatedKey =
                  measureTranslations[key as keyof typeof measureTranslations];
                return (
                  <li key={key}>
                    {translatedKey}: {value}
                  </li>
        ...
        <div>
          ...
          <ul>
            {Object.entries(bodyMeasurement).map(([key, value]) => {
              if (typeof value !== "object") {
                const translatedKey =
                  bodyMeasureTranslations[
                    key as keyof typeof bodyMeasureTranslations
                  ];
                return (
                  <li key={key}>
                    {translatedKey}: {value}
          ...
          <div className="mt-4 grid grid-cols-2 gap-4">
            <div>
              ...
              <ul>
                {Object.entries(bodyMeasurement.right).map(
                  ([innerKey, innerValue]) => {
                    const translatedInnerKey =
                      bodyMeasureTranslations[
                        innerKey as keyof typeof bodyMeasureTranslations
                      ];
                    return (
                      <li key={`right-${innerKey}`}>
                        {translatedInnerKey}: {innerValue}
                      </li>
                    );
                  }
                )}
            ...
            <div>
              ...
              <ul>
                {Object.entries(bodyMeasurement.left).map(
                  ([innerKey, innerValue]) => {
                    const translatedInnerKey =
                      bodyMeasureTranslations[
                        innerKey as keyof typeof bodyMeasureTranslations
        ...
        <form className="py-2" onSubmit={handleSubmit(handleForm)}>
          {currentStep === 0 && (
            ...
            >
              ...
              <p className="mt-1 text-sm">Selecione um aluno</p>
          ...
          {currentStep === 1 && (
            <motion.div
              ...
              transition={{ duration: 0.3, ease: "easeInOut" }}
            >
              <h2 className="text-base font-semibold">Tipo de Avaliação</h2>
          ...
          {currentStep === 2 && (
            ...
            >
              <h2 className="text-base font-semibold">
                Medidas Cutâneas (
                {getValues("assessmentType") === AssessmentTypeEnum.POLLOCK_3
                  ? "Pollock de 3 Dobras"
                  : "Pollock de 7 Dobras"}
                )
              </h2>
              <p className="mt-1 text-sm">Insira as dobras cutâneas.</p>
              <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                <div className="sm:col-span-3">
                  <div className="mt-2">
                    {getValues("assessmentType") ===
                    AssessmentTypeEnum.POLLOCK_3
                      ? renderPollock3()
                      : renderPollock7()}
                  </div>
                </div>
          ...
          {currentStep === 3 && (
            ...
            >
              ...
              <p className="mt-1 text-sm">Selecione o período da avaliação.</p>
              <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                <div className="sm:col-span-3">
                  <div className="mt-2">
                    <div>
          ...
          {currentStep === 4 && (
            <motion.div
              ...
              transition={{ duration: 0.3, ease: "easeInOut" }}
            >
              <h2 className="text-base font-semibold">Medidas Corporais</h2>
              <p className="mt-1 text-sm">
              ...
              <div className="mt-10 sm:grid-cols-6">
                <div className="sm:col-span-3 flex flex-row space-x-4">
                  <div className="mt-2">
                    <div>
                      <label htmlFor="bodyMeasurement.neck" className="label">
                        Pescoço
                      </label>
                      <input
                        type="text"
                        id="bodyMeasurement.neck"
                        {...register("bodyMeasurement.neck", {
                          valueAsNumber: true,
                        })}
                        className="input input-bordered w-full placeholder:opacity-60"
                      />
                    ...
                    <div>
                      <label
                        htmlFor="bodyMeasurement.shoulder"
                        className="label"
                      >
                        Ombro
                      </label>
                      <input
                        ...
                        {...register("bodyMeasurement.shoulder", {
                          valueAsNumber: true,
                        })}
                        className="input input-bordered w-full placeholder:opacity-60"
                      />
                    ...
                    <div>
                      <label htmlFor="bodyMeasurement.chest" className="label">
                        Peito
                      </label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label htmlFor="bodyMeasurement.waist" className="label">
                        Cintura
                      </label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label
                        htmlFor="bodyMeasurement.abdomen"
                        className="label"
                      >
                        Abdômen
                      </label>
                      <input
                        ...
                        {...register("bodyMeasurement.abdomen", {
                          valueAsNumber: true,
                        })}
                        className="input input-bordered w-full placeholder:opacity-60"
                      />
                    ...
                    <div>
                      <label htmlFor="bodyMeasurement.hip" className="label">
                        Quadril
                      </label>
                      <input
                        type="text"
                        id="bodyMeasurement.hip"
                        {...register("bodyMeasurement.hip", {
                          valueAsNumber: true,
                        })}
                        className="input input-bordered w-full placeholder:opacity-60"
                      />
                  ...
                  <div className="mt-2">
                    <div>
                      <label
                        htmlFor="bodyMeasurement.right.arm"
                        className="label"
                      >
                        Braço direito
                      </label>
                      <input
                        ...
                        {...register("bodyMeasurement.right.arm", {
                          valueAsNumber: true,
                        })}
                        className="input input-bordered w-full placeholder:opacity-60"
                      />
                    ...
                    <div>
                      <label
                        htmlFor="bodyMeasurement.right.forearm"
                        className="label"
                      >
                        Antebraço direito
                      </label>
                      <input
                        ...
                        {...register("bodyMeasurement.right.forearm", {
                          valueAsNumber: true,
                        })}
                        className="input input-bordered w-full placeholder:opacity-60"
                      />
                    ...
                    <div>
                      <label
                        htmlFor="bodyMeasurement.right.thigh"
                        className="label"
                      >
                        Coxa direita
                      </label>
                      <input
                        ...
                        {...register("bodyMeasurement.right.thigh", {
                          valueAsNumber: true,
                        })}
                        className="input input-bordered w-full placeholder:opacity-60"
                      />
                    ...
                    <div>
                      <label
                        htmlFor="bodyMeasurement.right.calf"
                        className="label"
                      >
                        Panturrilha direita
                      </label>
                      <input
                        ...
                        {...register("bodyMeasurement.right.calf", {
                          valueAsNumber: true,
                        })}
                        className="input input-bordered w-full placeholder:opacity-60"
                      />
                  ...
                  <div className="mt-2">
                    <div>
                      <label
                        htmlFor="bodyMeasurement.left.arm"
                        className="label"
                      >
                        Braço esquerdo
                      </label>
                      <input
                        ...
                        {...register("bodyMeasurement.left.arm", {
                          valueAsNumber: true,
                        })}
                        className="input input-bordered w-full placeholder:opacity-60"
                      />
                    ...
                    <div>
                      <label
                        htmlFor="bodyMeasurement.left.forearm"
                        className="label"
                      >
                        Antebraço esquerdo
                      </label>
                      <input
                        ...
                        {...register("bodyMeasurement.left.forearm", {
                          valueAsNumber: true,
                        })}
                        className="input input-bordered w-full placeholder:opacity-60"
                      />
                    ...
                    <div>
                      <label
                        htmlFor="bodyMeasurement.left.thigh"
                        className="label"
                      >
                        Coxa esquerdo
                      </label>
                      <input
                        ...
                        {...register("bodyMeasurement.left.thigh", {
                          valueAsNumber: true,
                        })}
                        className="input input-bordered w-full placeholder:opacity-60"
                      />
                    ...
                    <div>
                      <label
                        htmlFor="bodyMeasurement.left.calf"
                        className="label"
                      >
                        Panturrilha esquerdo
                      </label>
                      <input
                        type="text"
                        id="bodyMeasurement.left.calf"
                        {...register("bodyMeasurement.left.calf", {
                          valueAsNumber: true,
                        })}
                        className="input input-bordered w-full placeholder:opacity-60"
                      />
          ...
          {currentStep === 5 && (
            <motion.div
              ...
              transition={{ duration: 0.3, ease: "easeInOut" }}
            >
              <h2 className="text-base font-semibold">Revisão</h2>
              <p className="mt-1 text-sm">Revise as informações.</p>
              <div className="mt-10">
                <div className="sm:col-span-3">
                  <div className="mt-2">{renderReview()}</div>
                </div>
              </div>
            </motion.div>
          )}
        ...
        <div className="mt-8 pt-5">
          <div className="flex flex-col space-y-24">
            ...
            <button
              ...
              onClick={next}
              className={`btn btn-primary ${
                currentStep === steps.length - 1 ? "btn-success" : ""
              }`}
            >
